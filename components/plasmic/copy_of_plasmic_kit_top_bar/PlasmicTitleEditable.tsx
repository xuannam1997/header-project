...
import sty from "./PlasmicTitleEditable.module.css"; // plasmic-import: ftxp7wfjtxrZ/css
    ...
    >
      ...
      {(triggers.hover_root ? true : false)
        ? renderPlasmicSlot({
            defaultContents: (
              <EditSvgIcon
                className={classNames(projectcss.all, sty.svg___3SGQm)}
                role={"img"}
              />
            ),
