...
import sty from "./PlasmicVariantsMenu.module.css"; // plasmic-import: YvXv8qvNi4Jn/css

import SearchIcon from "../plasmic_kit_design_system/icons/PlasmicIcon__Search"; // plasmic-import: sjONHoK61vpSz/icon
