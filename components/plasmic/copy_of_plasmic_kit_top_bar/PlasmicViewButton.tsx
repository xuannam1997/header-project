...
import sty from "./PlasmicViewButton.module.css"; // plasmic-import: 7SX6mwYxPMS8/css
  ...
  return (
    (hasVariant($state, "mode", "live") ? false : true) ? (
      <Button
        ...
        endIcon={
          <ChevronDownSvgIcon
            className={classNames(projectcss.all, sty.svg__bo0Bj)}
            role={"img"}
          />
        }
        font={"dim"}
        ...
        startIcon={
          <ArrowRightSvgIcon
            className={classNames(projectcss.all, sty.svg___137Nt)}
            role={"img"}
          />
        }
        type={["clear"]}
