...
import ComponentIcon from "./icons/PlasmicIcon__Component"; // plasmic-import: nNWEF4jI3s5DI/icon
import EyeIcon from "./icons/PlasmicIcon__Eye"; // plasmic-import: A2FnGYgDh4e3U/icon
          ...
          {(
            ...
            <div
              ...
              className={classNames(projectcss.all, sty.rightContent, {
                [sty.rightContenthasRightContents]: hasVariant(
                  $state,
                  "hasRightContents",
                  "hasRightContents"
                )
            ...
            >
              <div
                data-plasmic-name={"rightContentText"}
                data-plasmic-override={overrides.rightContentText}
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
                  sty.rightContentText,
                  {
                    [sty.rightContentTexthasMenu]: hasVariant(
                      $state,
                      "hasMenu",
                      "hasMenu"
                    ),
                    [sty.rightContentTexthasRightContents]: hasVariant(
                      $state,
                      "hasRightContents",
                      "hasRightContents"
                    ),
                    [sty.rightContentTexthasRightContents_isSelected]:
                      hasVariant(
                        $state,
                        "hasRightContents",
                        "hasRightContents"
                      ) && hasVariant($state, "isSelected", "isSelected"),
                    [sty.rightContentTexthasRightContents_isSelected_color_variant]:
                      hasVariant($state, "color", "variant") &&
                      hasVariant($state, "isSelected", "isSelected") &&
                      hasVariant(
                        $state,
                    ...
                    [sty.rightContentTexthasRightContents_showActions]:
                      hasVariant(
                        $state,
                        "hasRightContents",
                        "hasRightContents"
                      ) && hasVariant($state, "showActions", "showActions"),
                    [sty.rightContentTexthideIcon]: hasVariant(
                      $state,
                      "hideIcon",
                      "hideIcon"
                    ),
                    [sty.rightContentTextshowActions]: hasVariant(
                      $state,
                      "showActions",
                      "showActions"
                    )
...
const PlasmicDescendants = {
  ...
  rightContent: ["rightContent", "rightContentText"],
...
export const PlasmicListItem = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    rightContentText: makeNodeComponent("rightContentText"),
