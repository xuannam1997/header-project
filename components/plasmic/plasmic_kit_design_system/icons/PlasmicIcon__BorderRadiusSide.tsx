...
export type BorderRadiusSideIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function BorderRadiusSideIcon(props: BorderRadiusSideIconProps) {
...
export default BorderRadiusSideIcon;
/* prettier-ignore-end */
