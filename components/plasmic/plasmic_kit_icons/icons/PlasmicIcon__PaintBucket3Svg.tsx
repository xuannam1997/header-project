...
export type PaintBucket3SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PaintBucket3SvgIcon(props: PaintBucket3SvgIconProps) {
...
export default PaintBucket3SvgIcon;
/* prettier-ignore-end */
